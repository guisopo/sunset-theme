<?php
  ...
  */
  ...
  if($contact == 1) {
    ...
    // manage_yourcustomposttype_post_columns
  ...
  // $columns is automatically passed by the filter
  ...
  function sunset_contact_add_meta_box() {
    add_meta_box( 'contact_email',                   //$id
                  'User Email',                      //$title
                  'sunset_contact_email_callback',   //$callback
                  'sunset-contact',                  //screen
                  'side'                            //$context
                );
  }

  //add metabox automatically will pass $post variable as an argument to his callback.
